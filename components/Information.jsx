                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div className="grid grid-cols-4 gap-6">
                    <div className="col-span-3 sm:col-span-2">
                      ...
                      >
                        Website{" "}
                        <CgWebsite color="blue" className="flex text-lg" />
                      </label>
                      <div className="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input
                          ...
                          id="company-website"
                          className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-900"
                    ...
                    <div className="col-span-3 sm:col-span-2">
                      ...
                      >
                        LinkedIn{" "}
                        <AiFillLinkedin color="blue" className="flex text-lg" />
                      </label>
                      <div className="mt-1 flex rounded-md shadow-sm">
                        <span className="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-900 bg-gray-50 text-gray-500 text-sm">
                          http://
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        name="about"
                        rows={3}
                        className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-900 rounded-md"
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center">
                      ...
                      <button
                        type="button"
                        className="ml-5 bg-white py-2 px-3 border border-gray-900 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      >
                        Change
                      </button>
                    </div>
